...
export function NavMegaBand({ columns, featured = [], onNavigate, className = "" }: NavMegaBandProps) {
    ...
    >
      <div className="page-wrap section-pad py-10 md:py-12 lg:py-14">
        <div
          className={
            featured.length > 0
              ? "grid lg:grid-cols-[minmax(0,1fr)_auto] gap-10 lg:gap-14 xl:gap-20 items-start"
              : ""
          }
        >
          <div
